...
mat3 compTBN(vec3 fs_pos, vec3 n_norm, vec2 fs_uv){
...
void main() {
	...
	vec3 norm = mix(normalVec, normalize(tbn * (nMap.xyz * 2.0 - 1.0)), u_effect.y);

    vec4 albedo = mix(u_color, texture(u_diffuseTexture, fs_uv)* u_color, u_effect.x);
    // vec4 albedo = u_color ;
...
setup = {
    ...
    _loadTextures: function () {
        ...
        this.textures = twgl.createTextures(gl, {
            ...
            normalenlarge: { crossOrigin: 'anonymous', src: "textures/power_up/normals/enlarge.png" },
            normalrestrict: { crossOrigin: 'anonymous', src: "textures/power_up/normals/restrict.png" },
            normalslow: { crossOrigin: 'anonymous', src: "textures/power_up/normals/slow.png" },
            normalfast: { crossOrigin: 'anonymous', src: "textures/power_up/normals/fast.png" },
        });
