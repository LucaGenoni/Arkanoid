...
void main() {
    ...
    float SpecShine = 1.0;
	vec4 Phong_l1 = pow(clamp(dot(c_dir, -reflect(dir_pos_l_fs,norm)),0.0,1.0), SpecShine) * OlightColor * (Seen_l1==0.0 ? 0.0:1.0);
	

    out_color = albedo * Lambert_l1 + l_color  * Phong_l1 ;
}
`;
setup = {
